...
<script lang="ts" setup>
    ...
    const emoticonSeleccionado = ref('');

    const emits = defineEmits(["selectedEmoticon"])

    const seleccionarEmoticon = (emoticon:string) => {
        emoticonSeleccionado.value = emoticon;
        emits("selectedEmoticon",emoticon)
    };
</script>
